...
import com.perculator.MultilineTransaction;
...
public class DocumentLauncher implements Runnable {
	...
	public String justRead(){
		...
		String result=tr.get(new Row(doc.url), new Column("contents"), "document");
		return result;
	}
	...
	public boolean updateDocument() {
		...
		System.out.println(doc.url+"     tried to write:"+updateFlag);
		System.out.println(doc.url+"     write succeeds:"+result);
		System.out.println("***********");
		return result;
	}
